...
def generate_report():
    ...
    annualized_return = (1 + total_return) ** (365 / days_in_backtest) - 1
    net_annualized_return_after_fees = annualized_return
...
| Net Annualized Return After Fees (%)| {net_annualized_return_after_fees:.2%} |
...
## Conclusion
The delta-neutral funding rate arbitrage strategy transforms crypto market volatility into a source of consistent, low-risk returns. With an annualized return of **{annualized_return:.2%}** and a Sharpe ratio of **{sharpe_ratio:.2f}**, it's a proven performer ready for investment. We invite you to connect with us to explore scaling this opportunity further.
